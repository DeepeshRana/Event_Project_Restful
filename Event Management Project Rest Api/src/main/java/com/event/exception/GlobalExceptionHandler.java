...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> handleRuntimeValidException(RuntimeException ex) {
		Map<String, String> resp = new HashMap<>();
		ErrorMessage errorMessage = new ErrorMessage(HttpStatus.BAD_REQUEST, "User Already Exists");
